...
wq_measure<-c("Impaired Watershed Area -- EPA '303(d)' list "="wq1","Stream Abundance "="wq2")
...
wq_measure_name<-c("Impaired Watershed Area -- EPA '303(d)' list ","Stream Abundance ")
...
names<-c("hab1","hab2","hab3","hab4","wq1","wq2","lcmr1","lcmr2","lcmr3","lcmr4","cl1","cl2","cl3","cl4","eco1","eco2","eco3","eco4")
names1<-c("padus","area_conne","Sleuth_v2","conl_index","Impaired_w","stream_abu","Biodiversi","TnE_area","TnE_Count","area_light","HistoricPl","area_nha","SOVInew","THREATINDE","WORKINGLAN","ComEng_ct","RecEng_ct","AR_boat")



data1<-st_read('./data/sca_landonly_withdata.shp')
